...
function updatePlayerGraph() {
    ...
    const canvas =
        document.getElementById("playerGraph");
...
function updateApiTime(data) {
    const el =
        document.getElementById("apiTime");
    if (!el) {
        return;
    }
    const timestamp =
...
function clearHistory() {
    if (
        !confirm(
            "Are you sure you want to clear all player history?"
        )
    ) {
        return;
    }
