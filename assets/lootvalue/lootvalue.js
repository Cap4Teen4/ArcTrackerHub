/* =========================================================
   ARC RAIDERS - STANDALONE LOOT TABLE
   Tracker Hub Version
   Images: ARC Raiders Wiki
========================================================= */
...
const WIKI_IMAGE =
    "https://arcraiders.wiki/wiki/Special:Redirect/file/";
...
const grid =
    document.getElementById("lootGrid");
...
if (
    ...
    console.error(
        "ARC Raiders Loot Table: required HTML elements were not found."
    );
